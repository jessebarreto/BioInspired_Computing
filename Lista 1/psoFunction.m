...
function [time, bestMinimumValue, bestMinimumPosition, bestMinimumValues] = psoFunction(costFunctionName, searchSpace, dimensions, particles, maxIter, threshold, direction, initialSpeed, maxSpeed, initialWeight, finalWeight, cognitiveCoeff, socialCoeff)
...
if nargin < 2
    error('psoFunction requires at least 2 arguments: costFunctionName and seachSpace');
elseif nargin == 2
    direction = 1;
    dimensions = 2;
    particles = 20;
