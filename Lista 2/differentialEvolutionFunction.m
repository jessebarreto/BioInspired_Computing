...
function [time, bestMinimumValue, bestMinimumPosition, bestMinimumValues] = differentialEvolutionFunction(costFunctionName, searchSpace, dimensions, population, maxIter, threshold, direction, initialMutationFactor, finalMutationFactor, crossOverRate)
    ...
    if nargin < 2
        error('deFunction requires at least 2 arguments: costFunctionName and seachSpace');
    elseif nargin == 2
        direction = 1;
        dimensions = 2;
        population = 20;
