...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [time, bestMinimumValue, bestMinimumPIDValues, bestMinimumValues] = psoPIDTunning(plantName, systemTF, systemNoiseTF, ...
  evaluationStepAmplitude, evaluationSignalTime, reference, searchSpace, dimensions, particles, maxIter, threshold, direction, ...
  initialSpeed, maxSpeed, initialWeight, finalWeight, cognitiveCoeff, socialCoeff)
...
for k=1:maxIter
   ...
   for i = 1:particles
      functionResult = systemControlEvaluation(plantName, individualCurPos(i, :)', 0.95, systemTF, systemNoiseTF, evaluationStepAmplitude, evaluationSignalTime, reference);
